...
// 자바 언어는 메서드만 제공하고, 함수는 제공하지 않음 (클래스 밖에서는 함수를 만들 수 없다는 것) !!
...
// 메서드 정의(선언) 방법: 
// [수식어] 리턴타입 메서드이름([파라미터 선언, ...]) { ... } / [대괄호]위치는 생략 가능.
// 메서드의 리턴값이 없는 경우에는 리턴 타입을 void라고 선언함.
...
public class MethodMain01 {
	...
	public static void main(String[] args) {
		...
		// println() 메서드를 호출 -> 호출 결과: 콘솔 창에 문자열을 출력.
