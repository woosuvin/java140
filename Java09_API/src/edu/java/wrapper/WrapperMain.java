...
// Wrapper 클래스: 자바의 기본타입의 값 하나를 저장하는(감싸는) 클래스
...
public class WrapperMain {
	...
	public static void main(String[] args) {
		...
		Integer number1 = Integer.valueOf(1); // boxing(wrapping): int 값 -> Integer 객체. return Integer
		...
		System.out.println(add); // 124
		
		int num = Integer.parseInt("567"); // return int
		System.out.println(num);
		
		// float, double 타입은 소수점 이하의 오차가 생길 수 있음.
		double d1 = 1.1;
		double d2 = 0.9;
		System.out.println(d1 - d2); // 1.1-0.9=0.2  0.20000000000000007
		...
		// BigDecimal 클래스는 기본 타입의 wrapper 클래스가 아니기 때문에 auto-boxing, auto-unboxing 기능이 없음.
