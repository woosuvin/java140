...
// final: 변경할 수 없는
// final 지역 변수: 값을 한 번 초기화 하면 그 값을 변경할 수 없는 변수(상수, constant).
...
public class InheritanceMain05 {
	...
	private final int x = 1; // (1) final 필드 x를 선언하면서 초기화.
	private final int y;
	public InheritanceMain05(int y) { // (2) final 필드 y를 초기화하는 생성자.
		this.y = y;                   //     생성자에서 명시적으로 초기화하는 코드가 있어야 함.
	}
