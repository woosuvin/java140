...
public class ArrayMain06 {
	...
	public static void main(String[] args) {
		...
		// 2차원 배열에서 length의 의미:
		System.out.println(idols.length); // idols의 length (아이돌 그룹의 개수)
		System.out.println(idols[0].length); // idols의 index 0번의 length (첫번째 아이돌 그룹의 멤버 수)
		System.out.println(idols[1].length); // idols의 index 1번의 length
		System.out.println(idols[2].length); // idols의 index 2번의 length
