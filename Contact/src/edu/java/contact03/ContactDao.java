...
public interface ContactDao {
	 ...
	 */
	int create(Contact c); // 리턴타입 int, argument Contact
	 ...
	 * @return 해당 인덱스의 연락처(Contact 타입) 객체 또는 null.
	 */
	Contact read(int index);
	
	/**
	 * 인덱스 수정 기능.
	 * @param index 수정할 연락처의 인덱스. 0 이상 ~ 저장된 연락처 개수보다 작은 정수.
	...
	/**
	 * 연락처 삭제 기능.
	 * @param index 삭제할 연락처의 인덱스. 0 이상 ~ 저장된 연락처 개수보다 작은 정수.
