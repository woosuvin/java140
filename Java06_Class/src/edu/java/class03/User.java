...
// - 생성자는 리턴 타입을 사용하지 않음! (void도 사용하지 않음.) 리턴타입 갖는 것 -> method

// 기본 생성자(default constructor): argument를 갖지 않는 생성자. parameter 선언이 없는 생성자.
...
//		this.userAge = 0;
	...
	public User(String userId, String userPassword, int userAge) {
		...
		this.userId = userId; // this.필드 user~ = 파라미터 user~;
...
//		this.userPassword = userPassword;
//		this.userAge = 0;
		this(userId, userPassword, 0); // 생성자 안에서 다른 생성자 사용하려면 this만 써야함.
	}
