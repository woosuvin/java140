...
// 클래스(class): 객체를 만들기 위해서 작성한 소스코드.
...
// - 프로그램 로딩 시점(main 메서드 시작 전)에 JRE이 사용하는 메모리 공간 중에서 메서드(method) 영역에 생성됨.
...
public class ModifierMain07 {
	...
	public static void main(String[] args) { 
		...
		test1(); // static 메서드는 static 멤버(필드, 메서드)를 사용할 수 있다.
//		test2(); -> static 메서드에서 인스턴스 멤버(필드, 메서드)를 사용할 수 없음.
		
		// ModifierMain07 타입의 객체를 먼저 생성. app->참조변수
