...
// 2. 다른 패키지에 있는 클래스는
//    (1) import 선언문을 사용하고 변수 선언에서 사용 가능.
//    (2) import 선언문 없이,
//        패키지 이름을 포함한 클래스 전체 이름(full name)을 변수 선언과 생성자 호출에서 사용.
// 3. JDK 패키지 중에서 java.lang 패키지의 클래스들은 import 선언문 없이 클래스 이름을 사용.
...
public class ModifierMain02 {
	...
	public static void main(String[] args) {
		...
		AccessTest test = new AccessTest(1, 2, 3, 4); // modifier01 패키지에 있는 클래스임.
