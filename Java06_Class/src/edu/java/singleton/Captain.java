...
// singleton = (1) private static 클래스 필드 + (2) private 생성자 + (3) public static 클래스 매서드
...
public class Captain {
	...
	// (1) private static으로 선언된 Captain 타입의 필드
	//     생성된 Captain 타입 객체의 주소 값을 저장하기 위한 필드
	// static 선언 목적 - 프로그램 로딩 시점에 메서드 영역의 메모리에 미리 변수를 만들어 두기 위해서.
	// private 선언 목적 - 필드의 값을 변경하는 것은 클래스 내부에서만 가능하도록 하기 위해서.
