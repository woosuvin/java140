...
public class InnerMain03 {
	...
	public static void main(String[] args) {
		...
		btnSave.setOnClikListener(listener2);
		...
		btnExit.setOnClikListener(listener3);
		btnExit.click();
		
		Button btnHelp = new Button("도움말");
		btnHelp.setOnClikListener(new OnClickListener() {
		...
		// 람다 표현식: 추상 메서드가 오직 한개인 인터페이스 구현 클래스를 간단히 표현하는 방법.
		btnEdit.setOnClikListener(() -> { System.out.println("파일 편집"); });
		btnEdit.click();
