...
// 인터페이스가 가질 수 있는 멤버들:
//   (1) public static final field. 필드 선언할 때 보통 public static final은 생략 가능. 
//   (2) public abstract method. 메서드 선언할 때 보통 public abstract는 생략 가능.
...
public class InterfaceMain01 {
	...
	public static void main(String[] args) {
		System.out.println(DB_VERSION); // -> import static 문장을 사용하면 DatabaseModule.DB_VERSION을 간단히 DB_VERSION으로 사용할 수 있다.
//		DatabaseModule.DB_VERSION = 2; -> final field이기 때문에 오류.
